...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm', array(
	...
	<div  >
		<?php echo $form->passwordFieldControlGroup($model,'new_password',array('span'=>5,'maxlength'=>128,'value'=>$pass_value)); ?>
	</div>
	
	<div  >
		<?php echo $form->passwordFieldControlGroup($model,'new_password_repeat',array('span'=>5,'maxlength'=>128,'value'=>$pass_value)); ?>
	</div>
